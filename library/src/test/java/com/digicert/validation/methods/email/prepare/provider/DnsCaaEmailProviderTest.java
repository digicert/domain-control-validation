...
public class DnsCaaEmailProviderTest {
    ...
    void testFindEmailsForDomainCaa_HappyPath() throws PreparationException {
        ...
        MpicDetails mpicDetails = new MpicDetails(true, "primary-agent-id", 2, 2, DnssecDetails.notChecked(), Collections.emptyMap(), null);
        ...
        Set<EmailDnsDetails> emails = emailDetails.emails();
