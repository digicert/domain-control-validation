 ...
 * The emails field represents the emails found at the target domain for the given record type, which can
 * be used to validate the domain. The mpicDetails field represents a summary of the MPIC details, which includes
