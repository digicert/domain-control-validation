 ...
 * was successful,the DNS server used, the domain and DNS type involved, the valid random value or token used, and any
 ...
 *
 * @param validToken       The valid token used in the validation.
 *
